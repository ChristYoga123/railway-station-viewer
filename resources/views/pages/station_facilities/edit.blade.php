    ...
    <div class="w-full px-4">
        <nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-8 px-12">
            <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-4 px-4">
                <a class="text-white text-lg uppercase hidden md:inline-block font-semibold" href="{{ route('stationFacility.index') }}">Edit Facility</a>
            </div>
        ...
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
            <div class="mb-4 ml-8 mt-8">
                <a href="{{ route('admin.stationFacility.index') }}" class="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-pink-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
            ...
            <x-divider class="mt-4 mb-2 mx-8" />
                ...
                <form action="{{ route('admin.stationFacility.update', $stationFacility->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <div class="w-full px-3">
                            ...
                            <input type="text" value="{{ old('name', $stationFacility->name ) }}" name="name" placeholder="Enter a new Facility name" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                        </div>

                        <div class="w-full px-3">
                            <label class="block uppercase tracking-wide text-gray-700 text-md font-bold my-4">Image</label>
                            <input type="hidden" value="{{ $stationFacility->image }}" name="old_image">
                            @if ($stationFacility->image)
                                <img src="/storage/{{ $stationFacility->image }}" class="img-preview block mb-3" width="200px">
                            @else
                        ...
                        <div class="w-full px-3">
                            ...
                            <textarea name="description" id="ckeditor"> {{ $stationFacility->description }} </textarea>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
